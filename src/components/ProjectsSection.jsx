...
const projects=[
    {
        ...
        title: "Hello World",
        description: " ",
        image: "https://deskbright-media.s3.amazonaws.com/static/cms/images/articles/excel/what-is-excel/image1.jpg",
...
export const ProjectsSection = () => {
    return <section id="projects" className="py-24 px relative">
        <div className="container mx-auto max-w-5xl">
            ...
            <div className="text-center mt-12">
                <a className="cosmic-button w-fit flex items-center mx-auto gap-2"
                    target="_blank"
                    href="https://github.com/VyDinhhh">
